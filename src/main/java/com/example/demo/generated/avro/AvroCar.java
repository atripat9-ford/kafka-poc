...
public class AvroCar extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8102890369841251523L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroCar\",\"namespace\":\"com.example.demo.generated.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"year\",\"type\":\"string\"},{\"name\":\"make\",\"type\":\"string\"},{\"name\":\"model\",\"type\":\"string\"},{\"name\":\"engine\",\"type\":\"string\"}]}");
   ...
   */
  public AvroCar(java.lang.Integer id, java.lang.CharSequence year, java.lang.CharSequence make, java.lang.CharSequence model, java.lang.CharSequence engine) {
    this.id = id;
    this.year = year;
    this.make = make;
    this.model = model;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: make = (java.lang.CharSequence)value$; break;
    case 3: model = (java.lang.CharSequence)value$; break;
    case 4: engine = (java.lang.CharSequence)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  /**
   * Creates a new AvroCar RecordBuilder by copying an existing Builder.
  ...
  /**
   * Creates a new AvroCar RecordBuilder by copying an existing AvroCar instance.
  ...
  /**
   * RecordBuilder for AvroCar instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroCar>
    ...
    /**
     * Creates a Builder by copying an existing AvroCar instance
     * @param other The existing instance to copy.
     */
    private Builder(com.example.demo.generated.avro.AvroCar other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    public AvroCar build() {
      try {
        ...
        record.make = fieldSetFlags()[2] ? this.make : (java.lang.CharSequence) defaultValue(fields()[2]);
        record.model = fieldSetFlags()[3] ? this.model : (java.lang.CharSequence) defaultValue(fields()[3]);
        record.engine = fieldSetFlags()[4] ? this.engine : (java.lang.CharSequence) defaultValue(fields()[4]);
        return record;
      } catch (Exception e) {
